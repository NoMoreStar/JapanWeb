                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 ">
                            ...
                            <div class="main_Search text-center colorstext1">
                            <font size=5 color="black">
                           		<table border="1">
                                <caption> Tabella generale terremoti </caption>
                                	<thead>
                                	<tr>
                                    	<th>
                                        	Codice Terremoto
                                ...
                                <?php
                                  ...
                                  try {
                                      ...
                                      $query = $connessione->query("SELECT CodiceT,Luogo,Magnitudo,Tsunami FROM Terremoto");
